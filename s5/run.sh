...
if [ $stage -le 3 ]; then
  ...
  utils/subset_data_dir.sh data/train 500 data/train.1k
...
if [ $stage -le 4 ]; then
  ...
  steps/train_deltas.sh --boost-silence 1.25 --cmd "$train_cmd"  \
      1600 15000 data/train data/lang exp/mono_ali exp/tri1
...
if [ $stage -le 5 ]; then
  ...
  steps/train_deltas.sh --cmd "$train_cmd"  \
      3200 30000 data/train data/lang exp/tri1_ali exp/tri2a
...
if [ $stage -le 6 ]; then
  ...
  steps/train_lda_mllt.sh --cmd "$train_cmd"  \
    ...
    3200 30000 data/train data/lang exp/tri2a_ali exp/tri2b
...
if [ $stage -le 7 ]; then
  ...
  steps/train_sat.sh --cmd "$train_cmd" 3200 30000 \
...
if [ $stage -le 8 ]; then
  ...
  steps/train_ubm.sh --cmd "$train_cmd"  \
      300 data/train data/lang exp/tri3b_ali exp/ubm5b2

  steps/train_sgmm2.sh --cmd "$train_cmd"  \
       4200 6000 data/train data/lang exp/tri3b_ali exp/ubm5b2/final.ubm exp/sgmm2_5b2
